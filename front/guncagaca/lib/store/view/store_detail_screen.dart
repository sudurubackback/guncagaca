...
class _StoreDetailScreenState extends State<StoreDetailScreen> {
  late bool isLiked;  // 찜 상태를 관리할 변수
  ...
  Future<StoreDetail> fetchStoreDetail() async {
    ...
    if (response.statusCode == 200) {
      return StoreDetail.fromMap(response.data); // 반환 타입을 변경
    } else {
                      ...
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Icon(
                              storeDetail!.isLiked ? Icons.favorite : Icons.favorite_border,
