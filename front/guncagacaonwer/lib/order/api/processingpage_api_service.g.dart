...
part of 'processingpage_api_service.dart';
...
class _ApiService implements ApiService {
  ...
  @override
  Future<OrderCompleteResponse> completeOrder(String orderId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<OrderCompleteResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = OrderCompleteResponse.fromJson(_result.data!);
    return value;
  }
